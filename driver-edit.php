...
Filename: driver-edit.php
Date Started: March 23, 2025
Date Finished: May 16, 2025
Purpose: this is the driver edit page for the JeepN! Tracking System. 
         It allows the admin to edit and update driver data, enable or disable user accounts, change passwords, and manage user claims.
         The page includes a form for editing driver information and buttons for enabling/disabling accounts and changing passwords.
         It also displays success or error messages based on the actions performed.
*/ -->
<?php
include('dbcon.php');
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                        ...
                        {
                            $uid = $_GET['id'];
                            $user = $database->getReference('drivers/'.$uid)->getValue();

                            if ($user) {
                    ?>
                        <form action="code.php" method="POST">
                            <input type="hidden" name="driver_id" value="<?= $uid ?>">
                            ...
                            <div class="form-group mb-3">
                                <button type="submit" name="update_driver_btn" class="btn btn-primary">Update Driver</button>
                            </div>
                        </form>
                    <?php
                            } else {
                                echo "<h5 class='text-danger'>Drivers not found.</h5>";
                            }
                        }
                    ?>
                </div>
