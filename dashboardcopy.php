...
Filename: dashboardcopy.php
Date Started: March 23, 2025
Date Finished: May 16, 2025
Purpose: This is the copy for dashboard page for the JeepN! Tracking System. 
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Welcome to JeepN! Tracking System</h4>
                </div>
                <div class="card-body">
                    <?php
                    if(isset($_SESSION['verified_user_id'])) {
                        ...
                        if($role === 'drivers') {
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-dark text-white">Masterlist (All Users)</div>
                                <div class="card-body">
                                                ...
                                                foreach ($fetchdata as $key => $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php } ?>
                                                            <a href="edit-info.php?id=<?= $key; ?>" class="btn btn-sm btn-info">Set Role/Remove</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
